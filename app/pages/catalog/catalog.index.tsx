          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1.5 border border-border/50 px-2.5 py-1.5">
              ...
              <select
                ...
                className="bg-transparent text-[11px] uppercase tracking-[0.16em] outline-none cursor-pointer border-0 p-0"
              >
                {SORT_OPTIONS.map((o) => (
            ...
            {filtered.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-28 text-center">
                ...
                <button
                  ...
                  className="mt-5 text-[11px] uppercase tracking-[0.2em] text-accent hover:underline underline-offset-4 cursor-pointer bg-transparent border-0"
                >
                  Reset Filters
                </button>
              </div>
